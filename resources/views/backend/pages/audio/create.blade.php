...
Vidoe
@endsection
@section('user-audio-create-active')
    active
@endsection
	                        ...
	                        <form action="{{route('audio.store')}}" method="POST" enctype="multipart/form-data">
	                                ...
	                                <div class="col-md-12 mb-4">
	                           		...
	                           		<div class="col-md-12 mb-4">
											<div class="">                                
			                                    <div class="row">
			                                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
			                                            <label for="exampleFormControlFile1">Audio Upload</label>
			                                        </div>
			                                    </div>
			                                </div>
											 <div class="">
		                        ...
		                        <div class="col-md-12">
	                        			<div class="col-md-12 mb-4">
		                                    ...
		                                    <input type="submit" name="" class="btn btn-primary submit-fn mt-2" value="Add Audio">
		                                </div>
	                        		</div>
		                        </div>
		                        <div class="row">
...
<script type="text/javascript">
  $(document).ready(function() {
    $('select[name="category_id"]').on('change', function(){
        ...
        if(category_id) {
            $.ajax({
                url: "{{  url('/user/audio/category/ajax/') }}/"+category_id,
                type:"GET",
                dataType:"json",
                success:function(data) {
                   ...
                   var d =$('select[name="subcategory_id"]').empty();
                      $.each(data, function(key, value){
                          ...
                          $('select[name="subcategory_id"]').append('<option value="'+ value.id +'">' + value.audio_sub_category_name + '</option>');
