...
Template
@endsection
@section('user-temp-create-active')
    active
@endsection
	        	...
	        	<div class="row layout-top-spacing">
	                ...
	                <div id="basic" class="col-lg-12 layout-spacing ">
	                    <div class="statbox widget box ">
	                        ...
	                        <form action="{{route('templete.store')}}" method="POST" enctype="multipart/form-data">
	                        	@csrf
		                        <div class="row mt-5">
		                        	<div class="col-md-6">
		                        ...
		                        <div class="col-md-6">
	                                ...
	                                <div class="col-md-12 mb-4">
	                                    <label for="dlink">Live Preview Link</label>
	                                    <input type="url" name="link_live_preview" class="form-control" id="dlink" placeholder="" value="" >
	                                </div>
	                                <div class="col-md-12 mb-4">
