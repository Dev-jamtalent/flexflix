...
@section('user-library-manage-active')
    active
@endsection
@section('user-library-show')
    show
@endsection
@section("body")
                                            ...
                                            <form class="simple-example"  method="post" id="upload_form" enctype="multipart/form-data" novalidate>
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-12 mb-4">
                                                        ...
                                                        <input type="text" readonly class="form-control" value="{{$library->name}}" placeholder="" value="" required>
                                                        
                                                        <div class="invalid-feedback">
                                                            Please fill the Category name
                                                        </div>
                                                    </div>
                                                    <input type="hidden" name="library_id"id="library_id"value="{{$library->id}}">
                                                    <div class="col-md-12 mb-4">
                                                        <label for="id">Book Name</label>
                                                        
                                                        <select class="form-control  basic"  id="id" name="id">
                                                            @foreach(App\Models\Book::where('user_id',Auth::User()->id)->whereNull('library_id')->get() as $book)
	...
	function clearData(){
     ...
     function allData() {
        ...
        $.ajax({
          type: "GET",
          dataType: "json",
          url: "/user/flexflix/library/all-book-show/"+id,
          ...
          success:function (response) {
            ...
            $.each(response, function(key,value){
              ...
              data = data + "<tr>"
              data = data + "<td>" +value.book.title+ "</td>"
      ...
      $.ajax({
       url:"{{ url('/user/flexflix/library/book-store') }}",
       method:"POST",
