                                        ...
                                        <div class="widget-content widget-content-area">
                                            <form class="simple-example"  method="post" id="upload_form" enctype="multipart/form-data" novalidate>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-12 mb-4">
                                                        <label for="name">Library Thumbnail</label>
                                                ...
                                                <button class="btn btn-primary submit-fn mt-2" id="addBtn" onclick="addData()" type="submit">Add Library</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
    ...
    function clearData(){
     ...
     function allData() {
        $.ajax({
          type: "GET",
          dataType: "json",
          url: "/user/flexflix/library/all",
          success:function (response) {
            var data = "";
            $.each(response, function(key,value){
                var id =  parseInt(value.id);
                var url = "{{route('library.all.book', '')}}"+"/"+value.id;
              ...
              data = data + "<td>"
              data = data + "<a  href = "+url+" class = 'btn btn-primary mr-2 btn-sm'> Add Book </a>"
              data = data + "</td>"
              data = data + "<td>"
      ...
      $.ajax({
       url:"{{ url('/user/flexflix/library/store') }}",
       method:"POST",
