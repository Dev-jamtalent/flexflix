...
@section('user-post-manage-active')
    active
@endsection
	                            ...
	                            <div class="statbox widget box box-shadow">
	                        		<div class="widget-content widget-content-area">
	                                    ...
	                                    <div class="card component-card_9">
	                                        <img src="{{ asset($post->image) }}" class="card-img-top img-fluid" alt="widget-card-2">
	                                        <div class="card-body">
	                                            <p class="meta-date">25 Sep 2020</p>

	                                            <h5 class="card-title">{{$post->title}}</h5>
	                                            <p class="card-text">{{$post->s_description}}</p>
	                                            ...
	                                            <div class="meta-info">
	                                                <div class="meta-action">
	                                                    <div class="meta-likes">
	                                                    	...
	                                                    	<a href="{{$post->id}}" data-toggle="modal" data-target="#exampleModalCenter{{$post->id}}"><span style="color: black; padding-right: 5px"><img src="{{ asset('backend') }}/icon/trash-2.svg" width="20px"></span></a>
			                                                    	<!-- Modal -->
			                                        	...
			                                        	<form action="{{route('post.delete',$post->id)}}" method="POST">
			                                        		...
			                                        		<div class="modal-content">
				                                                ...
				                                                <div class="modal-body">
				                                                    <h4 class="modal-heading mb-4 mt-2">Are You Want to sure delete This Post?</h4>
				                                                    <p class="modal-text">{{$post->title}}</p>
