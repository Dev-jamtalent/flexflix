...
@section('user-channel-create-active')
    active
@endsection
@section('user-channel-show')
    show
@endsection
@section("body")
        ...
        $.ajax({
          ...
          success:function (response) {
            ...
            $.each(response, function(key,value){
                ...
                var url = "{{route('channel.all.video', '')}}"+"/"+value.id;
              ...
              data = data + "</td>"
              data = data + "<td>"
              data = data + "<a  href = "+url+" class = 'btn btn-primary mr-2 btn-sm'> Add Video </a>"
              data = data + "</td>"
              data = data + "</tr>"
            })
            $('tbody').html(data);
