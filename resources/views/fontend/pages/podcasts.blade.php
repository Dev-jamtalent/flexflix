                    ...
                    <div class="channels-content">
                        ...
                        <div class="theme-section">
                            <div class="row">
                                ...
                                @php
                                $podcastAudioCount = App\Models\PodcastAudio::where('podcast_id',$data->id)->count();
                                @endphp
                                <div class="col-md-3 col-sm-4">
                                    <div class="cns-block">
                                        <a href="{{route('home.podcast.details',[$data->id,$data->slug])}}" class="cns-image">
                                ...
                                <div class="col-md-3 col-sm-4">
                                    <div class="cns-block">
                                        ...
                                        <div class="cns-info">
                                            <h5>{{$data->name}}<I class="arrow"></I></h5>
                                            <span>27,548 Subscribers</span>
                                            <span>{{$podcastAudioCount}} Audios</span>
                                            <span>10 Million Views</span>
