                ...
                <div class="content-block">
                    ...
                    <div class="channels-content">
                        ...
                        <div class="theme-section">
                            <div class="row">
                                @foreach($digitalstores as $data)
                                @php
                                $bookCount = App\Models\DigitalStoreTemplate::where('digital_store_id',$data->id)->count();
                                @endphp
                                <div class="col-md-3 col-sm-4">
                                    <div class="cns-block">
                                        <a href="{{route('home.digitalstore.details',[$data->id,$data->slug])}}" class="cns-image">
                                            <img src="{{asset($data->image)}}" alt="image">
                                        </a>
                                        <div class="cns-img-small">
                                            <div class="cns-small-wrapp">
                                                <img src="{{asset($data->user->profile_photo_path)}}" alt="small">
                                            </div>
                                        </div>
                                        <div class="cns-info">
                                            <h5>{{$data->name}}<I class="arrow"></I></h5>
