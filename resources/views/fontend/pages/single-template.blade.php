    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-xs-12 col-sm-12">
                <div class="sv-video">
                    <img src="{{ asset($template->image) }}" class="img-fluid"style="width:100%;height:100%;"  width="100%" height="100%" >
                ...
                <div class="author">
                    <div class="author-head">
                        <a href="#"><img src="{{ asset($template->user->profile_photo_path) }}" alt="" class="sv-avatar"></a>
                        <div class="sv-name">
                            <div><a href="{{route('home.user.details',[$template->user->id,$template->user->slug])}}">{{$template->user->name}}</a> .</div>
                ...
                <div class="info">
                        ...
                        <div class="tabs-content">
                            ...
                            <div class="tab-1">
                                <div>
                                    ...
                                    <h4>Sub-Category :</h4>
                                    <p>
                                    {{$template->subCategory->templete_sub_category_name}}
                                    </p>
                                    ...
                                    <p class="sv-tags">
                                        ...
                                        <span><a href="#">{{$tag->templete_tag_name}}</a></span>
                                        @endforeach
                                    </p>
                                    ...
                                    <div class="row date-lic">
                                        <div class="col-xs-6">
                                            <h4>Release Date:</h4>
                                            <p>{{$template->created_at->diffForHumans()}}</p>
                                        </div>
                                ...
                                <div class="hidden-xs">
                                    ...
                                    <a href="{{$template->link_live_preview}}" class="btn">Live Preview</a>
                                </div>
                                <div class="clearfix"></div>
                            ...
                            <div class="tab-3">
                                ...
                                <div class="tags-type2">
                                    <a href="{{$template->link_g_drive}}" target="_blank"><i class="fa fa-long-arrow-down" aria-hidden="true"></i>Google Drive</a>
                                    <a href="{{$template->link_dropbox}}" target="_blank"><i class="fa fa-long-arrow-down" aria-hidden="true"></i>Drop Box</a>
                                    <a href="{{$template->link_git_hub}}" target="_blank"><i class="fa fa-long-arrow-down" aria-hidden="true"></i>Git Hub</a>
                                    <a href="{{route('template.download',$template->id)}}" target="_blank"><i class="fa fa-long-arrow-down" aria-hidden="true"></i>Download</a>
                    ...
                    <div class="single-v-footer">
                        ...
                        <div class="similar-v single-video video-mobile-02">
                            <div class="row">
                                @forelse(App\Models\Template::orWhere('title', 'LIKE' ,$template->title)->orWhere('user_id',$template->user_id)->where('id', '!=' ,$template->id)->get()->take(10) as $insData)
                                    @if($insData->id === $template->id)
                                    @else
                                    <div class="col-lg-3 col-sm-6 col-xs-12">
                                        <div class="h-video row">
                                            <div class="col-sm-12 col-xs-6">
                                                <div class="v-img">
                                                    <a href="{{route('home.template.details',[$insData->id,$insData->slug])}}"><img src="{{ asset($insData->image) }}" alt=""></a>
                                                    
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-xs-6">
                                                <div class="v-desc">
                                                    <a href="{{route('home.template.details',[$insData->id,$insData->slug])}}">{{$insData->title}}</a>
                                                </div>
                                                <div class="v-views">
                                                    630,347 views
                                                </div>
